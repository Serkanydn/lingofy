              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Unlock 500+ premium content, detailed statistics, and
                    ad-free experience
                  </p>
                </div>
              </div>
          ...
          {[
            {
              ...
              description:
                "Select content matching your English proficiency from A1 to C1",
            },
            {
              step: "2",
              title: "Learn & Practice",
              description:
                "Read texts, listen to audio, and study grammar at your own pace",
            },
            {
              step: "3",
              title: "Test Your Knowledge",
              description:
                "Take quizzes, build vocabulary, and track your progress",
            },
          ].map((item) => (
