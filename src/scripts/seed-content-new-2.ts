  ...
  // ====== B2 LEVEL ======
  {
    ...
    quiz: {
      ...
      questions: [
        ...
        {
          question_type: 'tf',
          question_text: 'Coffee houses became places for social and intellectual gatherings.',
          points: 5,
          order_index: 3,
          options: [
            { text: 'True', is_correct: true },
  ...
  // ====== C1 LEVEL ======
  {
    ...
    quiz: {
      ...
      questions: [
        {
          question_type: 'mc',
          question_text: 'According to the text, what is minimalism fundamentally about?',
          points: 10,
          order_index: 1,
          options: [
            { text: 'Making intentional choices about what adds value to life', is_correct: true },
        ...
        {
          question_type: 'mc',
          question_text: 'What criticism of minimalism is mentioned in the text?',
          points: 10,
          order_index: 2,
          options: [
            { text: 'It is often a privilege of the wealthy', is_correct: true },
        ...
        {
          question_type: 'tf',
          question_text: 'Frequent purging of items to maintain minimalism can paradoxically increase waste.',
          points: 5,
          order_index: 3,
          options: [
            { text: 'True', is_correct: true },
...
async function seedSimpleContent() {
  try {
    ...
    for (const item of readingContentWithQuizzes) {
      ...
      console.log(`  ✓ Level: ${reading.level} | Premium: ${reading.is_premium}\n`)
    }
