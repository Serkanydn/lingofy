...
const grammarTopics = [
  // ====== TENSES (2 topics) ======
  {
    ...
    explanation:
      "The Present Perfect connects past actions to the present, while the Past Simple refers to completed actions at a specific time in the past. Use Present Perfect for experiences, recent actions, or ongoing situations. Use Past Simple for finished actions with a clear time reference.",
    examples: [
    ...
    mini_text:
      "Sarah is a travel blogger. She has visited over 30 countries in her life. Last year, she went to Japan and stayed there for two months. She has never been to Australia, but she plans to go next year. Yesterday, she wrote a new blog post about her experiences. She has written more than 200 posts since she started her blog in 2018.",
    order_index: 1,
    quizzes: [
      {
  ...
  },
  {
    ...
    explanation:
      'Use "will" for spontaneous decisions, promises, predictions without evidence, and offers. Use "going to" for planned intentions, predictions based on present evidence, and decisions already made before speaking.',
    examples: [
  ...
  // ====== MODALS (2 topics) ======
  {
    ...
    explanation:
      'Both express obligation, but "must" comes from the speaker\'s authority or personal opinion, while "have to" refers to external rules or obligations. "Must not" expresses prohibition, while "don\'t have to" means no obligation.',
    examples: [
  ...
  },
  {
    ...
    explanation:
      '"Should" gives advice or expresses expectation and obligation. "Would" is used for hypothetical situations, polite requests, past habits, and the conditional form.',
    examples: [
  ...
  // ====== CONDITIONALS (2 topics) ======
  {
    ...
    explanation:
      "First Conditional (if + present, will + base verb) expresses real and possible future situations. Second Conditional (if + past simple, would + base verb) expresses hypothetical or unlikely present/future situations.",
    examples: [
  ...
  },
  {
    ...
    explanation:
      "The Third Conditional (if + past perfect, would have + past participle) expresses hypothetical situations in the past that did not happen. It's used for regrets, criticism, or imagining different past outcomes.",
    examples: [
  ...
  // ====== REPORTED SPEECH (2 topics) ======
  {
    ...
    explanation:
      "Reported speech (indirect speech) is used to tell someone what another person said without using their exact words. The tense usually shifts back one step, pronouns change, and time/place references may need adjustment.",
    examples: [
  ...
  },
  {
    ...
    explanation:
      'When reporting questions, use "asked" + question word + statement word order (no inversion). For yes/no questions, use "asked if/whether". For commands, use "told/asked + object + (not) to + infinitive".',
    examples: [
  ...
  // ====== ARTICLES (2 topics) ======
  {
    ...
    title: "A/An vs The",
    explanation:
      'Use "a/an" for non-specific singular countable nouns (first mention or general). Use "the" for specific nouns (already mentioned, unique, or clear from context). "A" before consonant sounds, "an" before vowel sounds.',
    examples: [
  ...
  },
  {
    ...
    explanation:
      "No article (zero article) is used with plural and uncountable nouns when speaking generally, with most proper nouns (names, countries, cities), meals, sports, languages, and academic subjects.",
    examples: [
    ...
    mini_text:
      "My name is David and I live in London. I study medicine at university. I love science and enjoy learning about biology and chemistry. In my free time, I play tennis and go swimming. For breakfast, I usually have toast and coffee. I speak English and Spanish fluently. My favorite food is pizza, and I often eat it for dinner. On weekends, I visit museums and go to parks. Life in London is exciting and full of opportunities.",
    order_index: 12,
    quizzes: [
      {
  ...
  // ====== PREPOSITIONS (2 topics) ======
  {
    ...
    explanation:
      'Use "at" for specific times, "on" for days and dates, "in" for months, years, centuries, and longer periods. These prepositions help specify when something happens.',
    examples: [
  ...
  },
  {
    ...
    explanation:
      'Use "at" for specific points/locations, "on" for surfaces, and "in" for enclosed spaces. These help describe where something or someone is located.',
    examples: [
    ...
    mini_text:
      "Tom is at work right now. His office is in the city center, on the 5th floor of a tall building. His desk is in the corner of the room, and his computer is on his desk. There are some photos on the wall behind him. At lunchtime, he usually eats at a café nearby. The café is on Main Street, in a small building. In the evening, Tom goes home. He lives in an apartment on Park Avenue. At night, he relaxes on the sofa and watches TV.",
    order_index: 14,
    quizzes: [
      {
  ...
  // ====== PHRASAL VERBS (2 topics) ======
  {
    ...
    explanation:
      'Phrasal verbs with "up" often indicate completion, increase, or upward movement. The meaning can be literal or idiomatic. Many cannot be translated word-by-word.',
    examples: [
  ...
  },
  {
    ...
    explanation:
      'Phrasal verbs with "out" often suggest movement away from something, completion, or discovery. They can be separable or inseparable depending on the specific verb.',
    examples: [
    ...
    mini_text:
      "Last week, I tried to figure out why my computer wasn't working. I looked online and found out that I needed to update the software. The solution turned out to be quite simple! Yesterday, I ran out of coffee, so I went to the store. While shopping, I ran into an old friend - what a surprise! We went out for lunch and talked for hours. She told me she works out every day at a new gym. She invited me to check it out. I think I'll try it out next week!",
    order_index: 16,
    quizzes: [
      {
  ...
  // ====== TRICKY TOPICS (2 topics) ======
  {
    ...
    explanation:
      '"Used to" describes past habits or states (no longer true). "Be used to" means be accustomed to something (followed by noun/-ing form). "Get used to" means become accustomed to something (process of adapting).',
    examples: [
  ...
  },
  {
    ...
    title: "Make vs Do",
    explanation:
      'Use "make" for creating, producing, or constructing something. Use "do" for activities, actions, or tasks (especially general ones). Many collocations must be memorized.',
    examples: [
  ...
  try {
    for (const topic of grammarTopics) {
      ...
      for (const questionData of topic.quizzes) {
        ...
        // Insert options
        const optionsToInsert = questionData.options.map((opt: any) => ({
