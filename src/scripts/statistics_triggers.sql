...
-- Auto-update user statistics when activities happen
-- =====================================================
...
-- =====================================================
-- Note: Reading completion will be tracked via quiz attempts
-- when content_id matches a reading_content record

-- =====================================================
-- LISTENING COMPLETION TRACKING
-- =====================================================
-- Note: Listening completion will be tracked via quiz attempts
-- when content_id matches a listening_content record
...
-- Trigger for quiz completion (using actual table name: user_question_attempts)
...
DECLARE
  v_user_id uuid;
BEGIN
  -- Get current user ID (you'll pass this from your app)
  v_user_id := auth.uid();
