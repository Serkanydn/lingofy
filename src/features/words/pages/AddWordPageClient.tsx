...
import { addWordSchema, UpdateWordInput, type AddWordInput } from "../types/validation";
...
export function AddWordPageClient() {
  ...
  }, [initialWord, initialCategoryId, sourceType, sourceId, form]);
              ...
              >
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="e.g., excellent" className="rounded-2xl h-14 text-lg border-2 border-gray-200 dark:border-gray-700 focus:border-orange-500 dark:focus:border-orange-500 transition-all duration-300" {...field} />
                        </FormControl>
                        <FormMessage />
                        <p className="text-sm text-gray-500 dark:text-gray-400">Enter the English word you want to learn</p>
                      </FormItem>
                    )}
                  />
                </div>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea rows={4} placeholder="e.g., An adjective meaning very good or of high quality. Used to describe something that is exceptional or outstanding." className="rounded-2xl text-base border-2 border-gray-200 dark:border-gray-700 focus:border-orange-500 dark:focus:border-orange-500 transition-all duration-300 resize-none" {...field} />
                        </FormControl>
                        <FormMessage />
                        <p className="text-sm text-gray-500 dark:text-gray-400">Provide a clear definition and explanation of the word</p>
                      </FormItem>
                    )}
                  />
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Button type="button" variant="outline" size="sm" onClick={() => append("")} className="rounded-2xl border-2 border-gray-200 dark:border-gray-700 hover:border-orange-500 dark:hover:border-orange-500 hover:bg-orange-50 dark:hover:bg-orange-900/10 transition-all duration-300">
                    ...
                    {fields.map((field, index) => (
                      <div key={field.id} className="relative">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  <FormControl>
                                    <Textarea rows={3} placeholder={`Example ${index + 1}: "She did an excellent job on the project, exceeding all expectations."`} className="rounded-2xl text-base border-2 border-gray-200 dark:border-gray-700 focus:border-orange-500 dark:focus:border-orange-500 transition-all duration-300 resize-none" {...field} />
                                  </FormControl>
                                  <FormMessage />
                                </FormItem>
                              )}
                          ...
                          {fields.length > 1 && (
                            <Button type="button" variant="ghost" size="icon" onClick={() => remove(index)} className="shrink-0 rounded-xl hover:bg-red-50 dark:hover:bg-red-900/20 hover:text-red-600 dark:hover:text-red-400 h-10 w-10 mt-2">
                ...
                <div className="flex gap-4 pt-6 border-t border-gray-200 dark:border-gray-800">
                  <Button type="button" variant="outline" onClick={() => router.push("/my-words")} className="flex-1 rounded-2xl h-14 text-base border-2 border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 transition-all duration-300">
                    Cancel
                  </Button>
                  <Button type="submit" className="flex-1 rounded-2xl h-14 text-base bg-linear-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 shadow-[0_4px_14px_rgba(249,115,22,0.4)] hover:shadow-[0_6px_20px_rgba(249,115,22,0.5)] transition-all duration-300" disabled={addWord.isPending || form.formState.isSubmitting}>
                    {addWord.isPending || form.formState.isSubmitting ? (
                      <>
