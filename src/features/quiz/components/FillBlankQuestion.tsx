    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between">
        <div className="flex-1">
          <h3 className="text-xl font-semibold leading-relaxed mb-4">Fill in the blank</h3>
        ...
        >
          ...
          {!isCorrect && (
            <div className="text-sm">
              ...
              <span className="font-medium text-red-800">{inputValue || '(empty)'}</span>
              <br />
              <span className="text-muted-foreground">Correct answer: </span>
              <span className="font-medium text-green-800">{correctAnswer}</span>
            </div>
          )}
        </div>
      )}
